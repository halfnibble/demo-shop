...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductBrand.slug'
        db.add_column(u'catalogue_productbrand', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='slug-1', max_length=50),
                      keep_default=False)

        # Adding field 'ProductActivity.slug'
        db.add_column(u'catalogue_productactivity', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='slug-1', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProductBrand.slug'
        db.delete_column(u'catalogue_productbrand', 'slug')

        # Deleting field 'ProductActivity.slug'
        db.delete_column(u'catalogue_productactivity', 'slug')
    ...
    models = {
        ...
        u'catalogue.product': {
            ...
            'activity': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['catalogue.ProductActivity']", 'null': 'True', 'blank': 'True'}),
            ...
            'brand': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['catalogue.ProductBrand']", 'null': 'True', 'blank': 'True'}),
        ...
        u'catalogue.productactivity': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'slug': ('django.db.models.fields.SlugField', [], {'default': "'slug-1'", 'max_length': '50'})
        },
