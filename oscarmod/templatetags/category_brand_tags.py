...
@register.tag(name="brand_categories")  # noqa (too complex (14))
def do_category_list(parse, token):
    tokens = token.split_contents()
    error_msg = ("%r tag uses the following syntax: {%% main_categories "
...
class CategoryTreeNode(template.Node):
    ...
    def get_annotated_list(self, max_depth=None, parent=None):
        ...
        # This is the magic where the list of Brands is made.
        categories = Category.objects.get(name='Brands').get_descendants()
